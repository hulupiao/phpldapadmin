		...
		*/
		$CACHE[$sortby] = function($a, $b){
                        ...
                        if (is_object($a) || is_object($b)) {
                                if (is_array($a->name)) {
                                        asort($a->name);
                                        $aa = array_shift($a->name);
                        } else $aa = $a->name;
                        if (is_array($b->name)) {
                                asort($b->name);
                                $bb = array_shift($b->name);
                        } else $bb = $b->name;
                        if ($aa != $bb)
                                return ($aa > $bb ? 1 : -1);
                        } else {
                                ...
                                if ((!isset($a['name'])) && isset($b['name'])) return 1;
                                if (isset($a['name']) && (!isset($b['name']))) return -1;
                                ...
                                if ($aa != $bb) if (is_numeric($aa) && is_numeric($bb)) {
                                        return ($aa > $bb ? 1 : -1);
                                } else {
                                        if (($c = strcasecmp($aa, $bb)) != 0) return $c;
                                }
                                }
                        }
                        return $c;
